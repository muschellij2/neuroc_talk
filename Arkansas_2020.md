...
Muschelli, J., Sweeney, E. M., Ullman, N. L., Vespa, P., Hanley, D. F., & Crainiceanu, C. M. (2017). **PItcHPERFeCT**: Primary intracranial hemorrhage probability estimation using random forests on CT. *NeuroImage: Clinical*, 14, 379-390.
  ...
  <img src="figures/Imaging_Pipeline_Flowchart_with_Rigid.png" style="width:75%; display: inline; margin: auto;">
  </div>
</div>



## <a href="https://neuroconductor.org/package/ichseg">ichseg: the PItcHPERFeCT Method of ICH Segmentation</a> <img src='figures/ichseg_logo.png' align="right" height="139" />
```r
