...
```{r, results="markup", out.width="10%", eval = FALSE}
knitr::include_graphics("figures/fslr_logo.png")
```

- `fslr` package - call FSL from R (requires FSL)
...
```{r, results="markup", out.width="85%", fig.align="center"}
knitr::include_graphics("figures/ichseg_example.png")
```

## lungct: Analysis of Lung CT Scans <img src='figures/lungct_logo.png' align="right" height="139" />

```{r, results="markup", out.width="75%", fig.align="center"}
knitr::include_graphics("figures/lungct_pipeline.png")
```
...
knitr::include_graphics("figures/dependency_graph.png")
```
...
1. No code = no method.  "Available upon request" - not great
