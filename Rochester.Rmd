...
author: 'John Muschelli, PhD - Johns Hopkins Bloomberg School of Public Health<br/> http://johnmuschelli.com/Rochester_2016.html <br/> <a href="https://twitter.com/strictlystat?lang=en">\@StrictlyStat</a> <br/> https://github.com/muschellij2'
...
<div id="left_col2"> 
  ...
  <div id="right_col2">
<img src="figures/Imaging_Pipeline_Flowchart_sized_box.png" style="width:75%; display: block; margin: auto;" alt="flow">
  </div>
</div>
...
<div class="container"> 
<div id="left_col2"> 
  <h2>Step 1: Create Predictors of ICH </h2>
...
<div id="left_col2"> 
  ...
  - V - voxels per person (really $V_i$)
  - P - number of predictors
  
 </div>    
  <div id="right_col2">   
  <img src="figures/voxel_stacking.png" style="width:100%;  display: block; margin: auto;" alt="MISTIE LOGO">  
  </div>
</div>  
...
- Generalized Additive Model `r citep("hastie_generalized_1990")` 
    - fit using thin plate splines (`mgcv` package)
...
[https://www.coursera.org/learn/neurohacking/](https://www.coursera.org/learn/neurohacking/)
   ...
   <div class="right-half">
   <img src="figures/neurohacking_logo.png" style="width:60%; display: block; margin: auto;" alt="neurohacking">
</div>
</div>
...
<div class="container"> 
   <div class="left-half" style="font-size: 28pt;">
   Elizabeth Sweeney <img src="figures/sweeney.jpg" style="width:20%; display: block; margin: auto;" alt="neurohacking">   

   Jean-Philippe Fortin <img src="figures/jp.png" style="width:20%; display: block; margin: auto;" alt="neurohacking">      
   
   
   Dan Hanley 
<img src="figures/Hanley.jpg" style="width:30%; display: block; margin: auto;" alt="Hanley">

</div>
   <div class="right-half">
   Brian Caffo
   <img src="figures/bcaffo.jpg" style="width:20%; display: block; margin: auto;" alt="neurohacking">
   
   Ciprian Crainiceanu
   <img src="figures/Ciprian.jpg" style="width:30%; display: block; margin: auto;" alt="neurohacking">      
   
   Adi Gherman
   <img src="figures/ghost.jpg" style="width:20%; display: block; margin: auto;" alt="neurohacking"> <p style = "font-size:10.5px;">From http://kingofwallpapers.com/ghost/ghost-011.jpg as no picture online can be found</p>
</div>
</div>

# Questions / It's OK to leave
