...
* Image ⇔ 3-dimensional array
    - composed of voxels
    - a typical CT has $512 \times 512 \times 30 ≈ 7.8$ million voxels
...
Statistical methods are just one part
  
  - Downstream from many steps 
  
  </div>    
  <div id="right_col2">
<img src="figures/PITCH_Imaging_Pipeline_Flowchart_short_box_stat.png" style="width:55%; display: block; margin: auto;" alt="flow">
  </div>
</div>
...
## This isn't atypical: lots of software choices
...
Statisticians involved with entire pipeline
...
<div id="left_col2"> 
  ...
  - [Medical Imaging Task View](https://cran.r-project.org/web/views/MedicalImaging.html) is good
    - no tutorials
  - [Neuroconductor Repository](https://github.com/neuroconductor-devel/)
  </p>
</div>    
  <div id="right_col2">
