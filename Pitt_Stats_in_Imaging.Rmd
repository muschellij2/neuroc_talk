...
## neurohcp: Human Connectome Project Downloader
...
- Tutorial on how to download in R: https://neuroconductor.org/neuroc-help-neurohcp
...
- [Tutorial on running with example data](http://johnmuschelli.com/neuroc/DTI_analysis_rcamino/index.html)
...
# Without Knowing How the Data <br>was Processed,<br> Analyses Cannot be Trusted
