...
author: 'John Muschelli<br/>http://johnmuschelli.com/Multimodal_Workshop.html<br/> Johns Hopkins Bloomberg School of Public Health'
output:
...
```{r, eval = FALSE}
library(neurobase) # similar to import lib
img = readnii("/path/to/image.nii.gz")
```
...
Data location: https://figshare.com/articles/SFO-example/5442298
...
```{r makefiles, echo = FALSE, cache = TRUE}
library(httr)
url = paste0(
